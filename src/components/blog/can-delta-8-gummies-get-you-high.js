...
export const CanDelta8GummiesGetYouHigh = ({ title, featuredImage, imgAlt }) => {
	return (
		<React.Fragment>
				...
				<article className="blog-post" itemScope itemType="https://schema.org/Article">
					...
					<section itemProp="articleBody">
						<div>
							...
							<p>
							Delta 8 the is one of over 200 cannabinoids. It is naturally occurring but not in large quantities by itself. 
							delta-8-tetrahydrocannabinol or Δ-8-tetrahydrocannabinol (Δ-8-THC). It is a cannabinoid molecule in marijuana 
							(cannabis) that's was recently legalized by the 2018 Federal Farm Bill.
							</p>
							<p>
							The THC binds with receptors -- mostly in the brain -- that control pain, mood, and other feelings. That's why 
							THC can make you feel euphoric and give you that so-called high.
							...
							<br />
							<h3>How do Delta 8 Gummies make you feel High like THC Would?</h3>
							<p>
							...
							<div>
								<div className="iframe-container md:hidden">
									<iframe
										...
										title="Can Delta 8 Gummies Get You High"
										allowFullScreen
									/>
								</div>
								<iframe
