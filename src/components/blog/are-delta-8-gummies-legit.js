...
export const AreDelta8GummiesLegit = ({ title, featuredImage, imgAlt }) => {
	return (
		<React.Fragment>
			...
			<div className="m-8 mt-4 md:m-32 md:mt-8">
				<article className="blog-post" itemScope itemType="https://schema.org/Article">
					...
					<section itemProp="articleBody">
						<div>
							<h2>The Most Legit Delta-8 Gummies On The Internet! Buy Your D8 Legit!</h2>
							<p>
							...
							<br />
							<h3>What Makes Delta 8 So Legit? ITS LEGAL AND ITS DANK</h3>
							<p>
