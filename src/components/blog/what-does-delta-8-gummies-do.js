...
import { BlogProductsRow } from '../../components/blog/blog-products-row';
import { BlogRow } from '../../components/page-components/main/blog-row';
import image2 from '../../images/blog-thumb-2.webp';
import { Link } from 'gatsby';

export const WhatDoesDelta8GummiesDo = ({ title, featuredImage, imgAlt }) => {
    return (
        <React.Fragment>
            ...
            <div className="m-8 mt-4 md:m-32 md:mt-8">
                ...
                >
                    ...
                    <section itemProp="articleBody">
                        <div>
                            <h1>What Does Delta 8 Gummies Do?</h1>
                            <p>
                                A popular question we receive when talking to
                                people is what does delta-8 gummies do. If you
                                are searching for the answer to what does delta
                                8 gummies do then you have found the right
                                place. In short, delta-8 THC gummies can give
                                you a bit of a “high” or “euphoric” feeling,
                                even though the experience is not going to be
                                the same as it would be with delta-9 THC. The
                                consensus among most users is that the euphoric
                                feelings produced by delta-8 are much less
                                intense, and much more enjoyable.
                            </p>
                            <br />
                            <img
                                src={image2}
                            ...
                            <br />
                            <h3>
                                How do Delta 8 Gummies do make you feel a
                                certain way?
                            </h3>
                            <p>
							...
							<h2>
								<strong>
									FAQ Question: What Do Delta-8 Edibles Do When You Ingest Them?
								</strong>
							</h2>
							<div>
								...
								<iframe
									...
									align="left"
									src="https://www.youtube.com/embed/qq8MjiuY9hY"
									title="When you eat delta 8 gummies what do they do/"
									allowFullScreen
								/>
