...
export const WhatDoesADelta8HighFeelLike = ({
    title,
    featuredImage,
    imgAlt
}) => {
            ...
            <div className="m-8 mt-4 md:m-32 md:mt-8">
                ...
                >
                    ...
                    <section itemProp="articleBody">
                        <div>
                            <h1>What Does Delta-8 Make You Feel Like?</h1>
                            <p>
                            ...
                            <br />
                            <h3>
                                How do Delta 8 Gummies make you feel the way
                                they do?
                            </h3>
                            <p>
							...
							<h2>
								<strong>
									What To Look for when asking what Does Delta-8 Make You Feel?
								</strong>
							</h2>
							<div>
								<div className="iframe-container md:hidden">
									<iframe
										...
										title="Delta-8 Gummies what do they make you feel like when you are high?"
										allowFullScreen
									/>
								</div>
								<iframe
									...
									align="center"
									src="https://www.youtube.com/embed/qq8MjiuY9hY"
									title="Delta 8 Edibles Most Popular Cannabis Store Product"
									allowFullScreen
								/>
