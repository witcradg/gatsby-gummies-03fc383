...
export const CanUBuyDelta8GummiesOnline = ({ title, featuredImage, imgAlt }) => {
	return (
		<React.Fragment>
			...
			<div className="m-8 mt-4 md:m-32 md:mt-8">
				<article className="blog-post" itemScope itemType="https://schema.org/Article">
					...
					<section itemProp="articleBody">
						<div>
							<h1>Can you Buy Delta-8 Gummies or Edibles Online?</h1>
							<p>
                               Ordering Delta-8 online has become increasing common as the products reaching the shelves across america are not always consistant or up to the standards we set for the industry. The problem is, not everywhere carries quality delta 8 edibles or reputable delta 8 gummy brands. 
							   Many consumers have turned to the internet to purchase their delta 8. Ordering Delta 8 Online is easy and gas is expensive. Why flip a coin wondering how the quality of your local vape shop, smoke shop, gas station or convenience store is. Just order your Delta 8 Edibles online. 
							   Simply find your state on this page and order the products we ship to your state. https://delta8gummies.com/locations/
                            </p>
							<br />
							<img src={image2} alt={imgAlt} style={{ float: 'right', margin: '1rem' }} />
							<br />
							<h3>When You Buy Delta 8 Gummies Online How do Delta 8 Gummies make you feel?</h3>
							<p>
							...
							<div>
								<div className="iframe-container md:hidden">
									<iframe
										...
										src="https://www.youtube.com/embed/qq8MjiuY9hY"
										title="Can I Buy Delta-8 Gummies On The Internet?"
										allowFullScreen
									/>
								</div>
								<iframe
									...
									align="center"
									src="https://www.youtube.com/embed/qq8MjiuY9hY"
									title="Buying Delta 8 Gummies Edibles Online, Can I?"
									allowFullScreen
								/>
