...
export const HowLongDoesDelta8GummiesHighLast = ({ title, featuredImage, imgAlt }) => {
	return (
		<React.Fragment>
			...
			<div className="m-8 mt-4 md:m-32 md:mt-8">
				<article className="blog-post" itemScope itemType="https://schema.org/Article">
					...
					<section itemProp="articleBody">
						<div>
							<h1>How Long Does Delta 8 High Last?</h1>
							<p>
							...
							<br />
							<h3>How do How Long Does Delta 8 High Last when you eat them?</h3>
							<p>
							...
							<h2>
								<strong>
									The Delta-8 High Will Last Different Periods of Time Depending on your Tollerance and how much you consume!
								</strong>
							</h2>
							<div>
								<div className="iframe-container md:hidden">
									<iframe
										...
										title="Delta-8 High last How Long?"
										allowFullScreen
									/>
								</div>
								<iframe
									...
									align="center"
									src="https://www.youtube.com/embed/qq8MjiuY9hY"
									title="If I eat Delta 8 Edible How long does high last?"
									allowFullScreen
								/>
