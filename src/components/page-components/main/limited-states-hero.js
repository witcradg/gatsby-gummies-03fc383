...
export const LimitedStatesHero = ({ usState }) => {
	const queryResult = useStaticQuery(
		graphql`
			query {
				markdownRemark(frontmatter: { component: { eq: "limited-states-hero" } }) {
					frontmatter {
						component
						date
						text
	...
	return (
		<div className="w-[100%] relative">
			...
			<div className="z-20 absolute top-0 tp-caption l-0 lg:ml-20">
				...
				<Link to="/collections/shop/" className="btn-xl btn-info hero-shop-now-btn page-indent">
					SHOP NOW!
				</Link>
				<br />
			</div>				
