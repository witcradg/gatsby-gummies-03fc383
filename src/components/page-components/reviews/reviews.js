...
import featuredImage from '../../../images/delta-8-gummies-reviews.webp';
import image2 from '../../../images/blog-thumb-2.webp';
import { Link } from 'gatsby';

const imgAlt = 'reviews of best delta-8 gummies';
			...
			<div className="m-8 mt-4 md:m-32 md:mt-8">
				<article className="blog-post" itemScope itemType="https://schema.org/Article">
					...
					<section itemProp="articleBody">
						<div>
							<h2>What to look for in a Delta 8 Gummies Review</h2>
							<p>
                             When reading reviews it is hard to know what you are looking at. So many different products, experiences and opinions.  </p>
							
			
							<br />
							<h2>
								<strong>
								Check Out Our 5 Star Delta-8 THC Reviews!!
								</strong>
							</h2>
