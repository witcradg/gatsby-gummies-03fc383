...
export const GummiesDescription = ({ children, totalContent, potency, count, totalCaseContent, caseCount }) => {
	const renderCaseTotal = () => {
		if (totalCaseContent)
			return (
				<li>
					<strong>Total ∆8THC Content Per Case:</strong>
		...
		<div>
			<div className="text-left">
				<SimpleAccordion>
					...
					<div className="block">
						<h6 className={styles.description_title}>About Delta 8 THC Gummies</h6>
						<p>
							Our Delta 8 THC gummies feature {potency} of Delta 8 THC in each gummy for maximum effects.
							They deliver a powerful head and body feel that will have you feeling amazing.
						</p>
						<p>
							Our Delta 8 THC gummies taste like normal gummies, with zero hemp taste. They are flat out
						...
						<br />
						<div>
							<h6 className={styles.description_title}>Delta 8 THC Gummies Product Description</h6>
							<ul style={{ color: '#777', listStyleType: 'disc' }}>
								<li>
									<strong>Total ∆8THC Content Per Jar:</strong>
								...
								{renderCaseCount()}
								<li>
									<strong>∆8THC Content Per Gummy:</strong>
									<span>&nbsp;{potency}</span>
								</li>
								<li>
									<strong>
			...
			<div className="text-left">
				<SimpleAccordion>
					...
					<div className="block">
						<ul style={{ color: '#777', listStyleType: 'disc' }}>
							<li>
								<strong>Total ∆8THC Content:</strong>
								<span>&nbsp;{totalContent}</span>
							</li>
							<li>
								<strong>∆8THC Content Per Gummy:</strong>
...
GummiesDescription.defaultProps = {
	totalContent: '1000mg'
};
