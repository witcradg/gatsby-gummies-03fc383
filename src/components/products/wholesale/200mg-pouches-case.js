...
export const PouchesCase = ({ productData }) => {
				...
				<div className="product-page page-padding">
					...
					<div className="flex-1 mt-2">
						<div>
							...
							{/* GoldStars */}
							<div className="big-text" style={{ color: '#f8353e' }}>
							...
							<AddToCart outOfStock={data.outOfStock} onChange={handleChange} >
								<button
...
data-item-category={data.dataItemCategory}
						...
						<div>
							<GummiesDescription
								...
								totalCaseContent={data.descriptionTotalCaseContent}
								caseCount={data.descriptionCaseCount}
							/>
						</div>
					</div>
				</div>
