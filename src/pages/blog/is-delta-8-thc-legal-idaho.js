...
import featuredImage from "../../images/legal-idaho-delta-8.png"
...
const IsDelta8THCLegalIdahoPage = ({ location, data }) => {
  const md = data.markdownRemark.frontmatter
  const postTitle = `Is Delta 8 THC Legal in ${md.statename} & Can I buy Delta 8 Gummies in ${md.statename}?`
    ...
    <Layout location={location}>
      <IsDelta8THCLegalState title={postTitle} data={data} answer={Answer}>
        ...
        <p>
          ...
          delta8gummies.com/locations/idaho/ ) and you will be able to checkout.
          If you try to purchase from any other page on the website it will not
          work!
        </p>
        <p>
...
export const query = graphql`
  query {
    markdownRemark(frontmatter: { statename: { eq: "Idaho" } }) {
      frontmatter {
        slug
        statename
        distribution
...
export default IsDelta8THCLegalIdahoPage
