...
import { PeachRings } from '../../components/products/peach-rings';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const PeachRingsPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "PeachRings" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
