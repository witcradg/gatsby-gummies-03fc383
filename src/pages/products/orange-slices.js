...
import { OrangeSlices } from '../../components/products/orange-slices';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const OrangeSlicesPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "OrangeSlices" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default OrangeSlicesPage;
