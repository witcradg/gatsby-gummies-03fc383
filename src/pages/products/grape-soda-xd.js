...
import { GrapeSodaXD } from '../../components/products/extended-distribution/grapesoda-xd';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const GrapeSodaXDPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const Head = ({ location, data }) => {
	...
	// const description = `${pageTitle} $29.99 Buy Hemp Derived Grape Soda Delta 9 thc Edibles made from Hemp in the USA. Shop D9 thc near me.`;
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "GrapeSodaXD" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default GrapeSodaXDPage;
