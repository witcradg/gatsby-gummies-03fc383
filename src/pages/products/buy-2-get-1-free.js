...
import { Buy2Get1Free } from '../../components/products/buy-2-get-1-free';
...
export const Head = ({ location, data }) => {
    ...
    // const description = `${pageTitle} 3 for the price of 2 delta 8 gummies. PLEASE NOTE: We can not ship Delta 8 products to the following states: Alaska, Arizona, Arkansas, Colorado, Delaware`;
