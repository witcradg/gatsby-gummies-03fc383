...
import { PeachRingsPouch } from '../../components/products/peach-rings-pouch';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const PeachRingsPouchPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<PeachRingsPouch productData={data}/>
		</Layout>
	);
};
...
export default PeachRingsPouchPage;
