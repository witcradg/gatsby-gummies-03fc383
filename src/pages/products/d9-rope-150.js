...
import { D9Nerds } from '../../components/products/d9-nerds';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const D9NerdsPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "D9Nerds" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
