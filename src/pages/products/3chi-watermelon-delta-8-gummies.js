...
import { ChiWatermelon } from '../../components/products/3chi-watermelon';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const ChiWatermelonPage = ({
    pageContext: {
        breadcrumb: { crumbs }
    },
    location,
    ...
    return (
        <Layout location={location}>
            ...
            />
            <ChiWatermelon productData={data} />
        </Layout>
    );
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "ChiWatermelon" } }) {
            frontmatter {
                title
                crumbsPath
                crumbsLabel
...
export default ChiWatermelonPage;
