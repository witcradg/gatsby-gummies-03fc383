...
import { SourApplePouch } from '../../components/products/sour-apple-pouch';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const SourApplePouchPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<SourApplePouch productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "SourApplePouch" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default SourApplePouchPage;
