...
import { NerdClusters } from '../../components/products/nerd-clusters';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const NerdClustersPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "NerdClusters" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default NerdClustersPage;
