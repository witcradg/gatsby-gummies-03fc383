...
import { FreeDelta8VeganApple } from '../../components/products/free-delta-8-vegan-apple';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const FreeDelta8VeganApplePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<FreeDelta8VeganApple productData={data}/>
		</Layout>
	);
};
...
export default FreeDelta8VeganApplePage;
