...
import { ThcoBearsXD } from '../../components/products/extended-distribution/thcobears-xd';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const ThcoBearsXdPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "ThcoBearsXD" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default ThcoBearsXdPage;
