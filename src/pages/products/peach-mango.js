...
import { PeachMango } from '../../components/products/peach-mango';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const PeachMangoPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
