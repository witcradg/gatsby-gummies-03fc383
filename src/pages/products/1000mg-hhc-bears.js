...
import { HHCBears } from '../../components/products/hhc-bears';
import Seo from '../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const HHCBearsPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "HHCBears" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
