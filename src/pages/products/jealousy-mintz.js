...
import { ThcaJealousyMintz } from '../../components/products/jealousy-mintz';
import { prices, formatSeoTitle, formatSeoDescription } from '/src/components/global';

const ThcaJealousyMintzPage = ({
    pageContext: {
        breadcrumb: { crumbs }
    },
    location,
    ...
    return (
        <Layout location={location}>
            ...
            />
            <ThcaJealousyMintz productData={data} />
        </Layout>
    );
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "ThcaJealousyMintz" } }) {
            frontmatter {
                title
                crumbsPath
                crumbsLabel
...
export default ThcaJealousyMintzPage;
