...
import { GummieBearsPouch } from '../../components/products/gummie-bears-pouch';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const GummieBearsPouchPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<GummieBearsPouch productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "GummieBearsPouch" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default GummieBearsPouchPage;
