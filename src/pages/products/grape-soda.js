...
import { GrapeSoda } from '../../components/products/grape-soda';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const GrapeSodaPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "GrapeSoda" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
