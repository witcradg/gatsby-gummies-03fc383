...
import { PartyPack } from '../../components/products/party-pack';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const PartyPackPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
