...
import { HHCMoonrockDisposable } from '../../components/products/hhc-moonrock-disposable';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const HHCMoonrockDisposablePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<HHCMoonrockDisposable productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "HhcMoonrockDisposable" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default HHCMoonrockDisposablePage;
