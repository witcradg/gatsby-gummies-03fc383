...
import { Zkittles } from '../../components/products/zkittles';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const ZkittlesPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "Zkittles" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
