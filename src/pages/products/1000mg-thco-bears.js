...
import { ThcoBears } from '../../components/products/thco-bears';
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "ThcoBears" } }) {
            frontmatter {
                title
                crumbsPath
                crumbsLabel
