...
import { AppleDots } from '../../components/products/apple-dots';
import Seo from '../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const AppleDotsPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "AppleDots" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
