...
import { AppleDotsPouch } from '../../components/products/apple-dots-pouch';
import Seo from '../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const AppleDotsPouchPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<AppleDotsPouch productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "AppleDotsPouch" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default AppleDotsPouchPage;
