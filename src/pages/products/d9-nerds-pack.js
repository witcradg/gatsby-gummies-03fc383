...
import { D9NerdsPack } from '../../components/products/d9-nerds-pack';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const D9NerdsPackPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "D9NerdsPack" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default D9NerdsPackPage;
