...
import { D9CubesPack } from '../../components/products/d9-cubes-pack';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const D9CubesPackPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "D9CubesPack" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default D9CubesPackPage;
