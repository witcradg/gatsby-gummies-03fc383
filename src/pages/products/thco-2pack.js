...
import { Thco2Pack } from '../../components/products/thco-2pack';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const THCO2PackPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const Head = ({location, data}) => {
	...
	// const description = `${pageTitle} $99.99 for 2000MG Vegan Delta 8 THC Gummies. PLEASE NOTE: We can not ship Delta 8 products to the following states: Alaska, Arizona, Arkansas, Colorado, Delaware`;
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "THCO2Pack" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
