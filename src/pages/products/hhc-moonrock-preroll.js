...
import { HHCMoonrockPreroll } from '../../components/products/hhc-moonrock-preroll';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const HHCMoonrockPrerollPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<HHCMoonrockPreroll productData={data}/>
		</Layout>
	);
};
...
export default HHCMoonrockPrerollPage;
