...
import { SamplePack5K } from '../../components/products/5000mg-sample-pack';
import Seo from '../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const SamplePack5kPage = ({
    pageContext: {
        breadcrumb: { crumbs }
    },
    location,
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "SamplePack5K" } }) {
            frontmatter {
                title
                crumbsPath
                crumbsLabel
...
export default SamplePack5kPage;
