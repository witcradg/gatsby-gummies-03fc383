...
import { ThcoRingsXD } from '../../components/products/extended-distribution/thcorings-xd';
import { prices, formatSeoTitle, formatSeoDescription } from '/src/components/global';

const ThcoRingsXdPage = ({
    pageContext: {
        breadcrumb: { crumbs }
    },
    location,
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "ThcoRingsXD" } }) {
            frontmatter {
                title
                crumbsPath
                crumbsLabel
...
export default ThcoRingsXdPage;
