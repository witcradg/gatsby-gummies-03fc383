...
import { SourSquares } from '../../components/products/sour-squares';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const SourSquaresPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "SourSquares" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default SourSquaresPage;
