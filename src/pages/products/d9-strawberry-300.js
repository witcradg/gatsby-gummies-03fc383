...
import { D9Strawberry } from '../../components/products/d9-strawberry';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const D9StrawberryPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export default D9StrawberryPage;
