...
import { ThcaDonnieBurger } from '../../components/products/donnie-burger';
import { prices, formatSeoTitle, formatSeoDescription } from '/src/components/global';

const ThcaDonnieBurgerPage = ({
    pageContext: {
        breadcrumb: { crumbs }
    },
    location,
    ...
    return (
        <Layout location={location}>
            ...
            />
            <ThcaDonnieBurger productData={data} />
        </Layout>
    );
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "ThcaDonnieBurger" } }) {
            frontmatter {
                title
                crumbsPath
                crumbsLabel
...
export default ThcaDonnieBurgerPage;
