...
import { SamplePack10K } from '../../components/products/10000mg-sample-pack';
import Seo from '../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const SamplePack10kPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<SamplePack10K productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "SamplePack10K" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default SamplePack10kPage;
