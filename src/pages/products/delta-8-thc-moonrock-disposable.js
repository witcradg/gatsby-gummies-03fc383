...
import { THCMoonrockDisposable } from '../../components/products/thc-moonrock-disposable';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const THCMoonrockDisposablePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<THCMoonrockDisposable productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "ThcMoonrockDisposable" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default THCMoonrockDisposablePage;
