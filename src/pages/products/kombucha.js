...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "ThcaKombucha" } }) {
            frontmatter {
                title
                crumbsPath
                crumbsLabel
...
export default ThcaKombuchaPage;
