...
import { PeachRingsCase } from '../../../components/products/wholesale/1000mg-delta-8-peach-rings-case';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const PeachRingsCasePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<PeachRingsCase productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "PeachRingsCase" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default PeachRingsCasePage;
