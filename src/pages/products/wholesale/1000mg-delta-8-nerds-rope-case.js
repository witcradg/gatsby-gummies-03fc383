...
// import productImage from '../../../images/wholesale-nerds-rope-delta-8.png';
import { NerdsRopeCase } from '../../../components/products/wholesale/1000mg-delta-8-nerds-rope-case';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const NerdsRopeCasePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
    ...
    return (
		<Layout location={location}>
			...
			<NerdsRopeCase productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "NerdsRopeCase" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default NerdsRopeCasePage;
