...
import { HhcBearsCase } from "../../../components/products/wholesale/wholesale-hhc-bears"
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const HhcBearsCasePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const Head = ({location, data}) => {
	...
	// const metaTitle = `${pageTitle} | HHC Gummies`;
	// const description = `${pageTitle} $59.99 PLEASE NOTE: We can not ship HHC products to the following states: Alaska, Arizona, Arkansas, Colorado, Delaware`;
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "HhcBearsCase" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default HhcBearsCasePage;
