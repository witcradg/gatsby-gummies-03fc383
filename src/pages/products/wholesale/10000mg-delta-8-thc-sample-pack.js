...
import { ThcSamplePack10KCase } from '../../../components/products/wholesale/10000mg-delta-8-thc-sample-pack';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const ThcSamplePack10KCasePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<ThcSamplePack10KCase productData={data}/>
		</Layout>
	);
};
...
export default ThcSamplePack10KCasePage;
