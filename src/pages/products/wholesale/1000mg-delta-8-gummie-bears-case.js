...
import { GummieBearsCase } from '../../../components/products/wholesale/1000mg-delta-8-gummie-bears-case';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const GummieBearsCasePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
    ...
    return (
		<Layout location={location}>
			...
			<GummieBearsCase productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "GummieBearsCase" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default GummieBearsCasePage;
