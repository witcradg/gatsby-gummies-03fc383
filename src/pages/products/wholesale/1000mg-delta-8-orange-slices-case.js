...
import { OrangeSlicesCase } from '../../../components/products/wholesale/1000mg-delta-8-orange-slices-case';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const OrangeSlicesCasePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<OrangeSlicesCase productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "OrangeSlicesCase" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default OrangeSlicesCasePage;
