...
import { BlackberryOgCase } from '../../../components/products/wholesale/delta-8-vape-carts-1ml-case-blackberry-og';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const BlackberryOgCasePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<BlackberryOgCase productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "BlackberryOgCase" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default BlackberryOgCasePage;
