...
import { SourWormsCase } from '../../../components/products/wholesale/1000mg-delta-8-sour-worms-case';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const SourWormsCasePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<SourWormsCase productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "SourWormsCase" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default SourWormsCasePage;
