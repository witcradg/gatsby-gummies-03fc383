...
import { CookiesAndCreamCase } from '../../../components/products/wholesale/vape-carts-1ml-case-cookies-cream';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const CookiesAndCreamCasePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<CookiesAndCreamCase productData={data}/>
		</Layout>
	);
};
...
export default CookiesAndCreamCasePage;
