...
import { WhiteTeaCase } from '../../../components/products/wholesale/white-tea-delta-8-icy-hot-case';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const WhiteTeaCasePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "WhiteTeaCase" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default WhiteTeaCasePage;
