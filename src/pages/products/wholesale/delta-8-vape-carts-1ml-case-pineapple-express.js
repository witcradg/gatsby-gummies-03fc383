...
// import productImage from '../../../images/vape-blackberry-og.png';
import { PineappleExpressCase } from '../../../components/products/wholesale/delta-8-vape-carts-1ml-case-pineapple-express';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const PineappleExpressCasePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<PineappleExpressCase productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "PineappleExpressCase" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default PineappleExpressCasePage;
