...
import { FourFlavorSamplePack } from '../../../components/products/wholesale/4-flavor-sample-pack';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const FourFlavorSamplePackPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<FourFlavorSamplePack productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "FourFlavorSamplePack" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default FourFlavorSamplePackPage;
