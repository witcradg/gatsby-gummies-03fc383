...
import { SensualRoseCase } from '../../../components/products/wholesale/sensual-rose-delta-8-icy-hot-case';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const SensualRoseCasePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<SensualRoseCase productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "SensualRoseCase" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default SensualRoseCasePage;
