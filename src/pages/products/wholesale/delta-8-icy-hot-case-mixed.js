...
import { IcyHotCaseMixed } from '../../../components/products/wholesale/delta-8-icy-hot-case-mixed';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const IcyHotCaseMixedPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<IcyHotCaseMixed productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "IcyHotCaseMixed" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default IcyHotCaseMixedPage;
