...
import { LavenderCase } from '../../../components/products/wholesale/lavender-delta-8-icy-hot-case';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const LavenderCasePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "LavenderCase" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default LavenderCasePage;
