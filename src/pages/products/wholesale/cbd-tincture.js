...
import { CbdTincture } from '../../../components/products/wholesale/cbd-tincture';
import Seo from '../../../components/new-seo';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const CbdTincturePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "CbdTincture" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default CbdTincturePage;
