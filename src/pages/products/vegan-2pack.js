...
import { Vegan2Pack } from '../../components/products/vegan-2pack';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const Vegan2PackPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
