...
import { ThcaGelato33 } from '../../components/products/gelato-33';
import { prices, formatSeoTitle, formatSeoDescription } from '/src/components/global';

const ThcaGelato33Page = ({
    pageContext: {
        breadcrumb: { crumbs }
    },
    location,
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "ThcaGelato33" } }) {
            frontmatter {
                title
                crumbsPath
                crumbsLabel
...
export default ThcaGelato33Page;
