...
import { ThcaPermanentMarker } from '../../components/products/permanent-marker';
import { prices, formatSeoTitle, formatSeoDescription } from '/src/components/global';

const ThcaPermanentMarkerPage = ({
    pageContext: {
        breadcrumb: { crumbs }
    },
    location,
    ...
    return (
        <Layout location={location}>
            ...
            />
            <ThcaPermanentMarker productData={data} />
        </Layout>
    );
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "ThcaPermanentMarker" } }) {
            frontmatter {
                title
                crumbsPath
                crumbsLabel
...
export default ThcaPermanentMarkerPage;
