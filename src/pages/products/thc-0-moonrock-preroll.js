...
import { THCOMoonrockPreroll } from '../../components/products/thco-moonrock-preroll';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const THCOMoonrockPrerollPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<THCOMoonrockPreroll productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "ThcoMoonrockPreroll" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default THCOMoonrockPrerollPage;
