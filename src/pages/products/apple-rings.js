...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "AppleRings" } }) {
            frontmatter {
                title
                crumbsPath
                crumbsLabel
