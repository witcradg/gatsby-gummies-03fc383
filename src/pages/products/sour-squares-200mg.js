...
import { SourSquaresPouch } from '../../components/products/sour-squares-pouch';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const SourSquaresPouchPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<SourSquaresPouch productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "SourSquaresPouch" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default SourSquaresPouchPage;
