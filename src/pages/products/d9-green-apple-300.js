...
import { D9GreenApple } from '../../components/products/d9-green-apple';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const D9GreenApplePage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export default D9GreenApplePage;
