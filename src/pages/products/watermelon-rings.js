...
import { WatermelonRings } from '../../components/products/watermelon-rings';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"


const WatermelonRingsPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<WatermelonRings productData={data}/>
		</Layout>
	);
};
...
export default WatermelonRingsPage;
