...
import { THCO2PackXD } from '../../components/products/extended-distribution/thco2pack-xd';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const Thco2PackXdPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "THCO2PackXD" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default Thco2PackXdPage;
