...
import { D9Cubes } from '../../components/products/d9-cubes';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const D9CubesPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "D9Cubes" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
