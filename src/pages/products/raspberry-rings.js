...
import { RaspberryRings } from '../../components/products/raspberry-rings';
// import productImage from '../../images/raspberry-rings-1000mg.png';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"


const RaspberryRingsPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<RaspberryRings productData={data}/>
		</Layout>
	);
};
...
export const Head = ({location, data}) => {
	...
	// const description = `${pageTitle} $49.99 PLEASE NOTE: We can not ship Delta 8 products to the following states: Alaska, Arizona, Arkansas, Colorado, Delaware`;
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "RaspberryRings" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default RaspberryRingsPage;
