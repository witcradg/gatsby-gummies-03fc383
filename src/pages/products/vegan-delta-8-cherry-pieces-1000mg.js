...
import { CherryPieces } from '../../components/products/cherry-pieces';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const CherryPiecesPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
...
export const Head = ({location, data}) => {
	...
	// const description = `${pageTitle} 20% OFF! PLEASE NOTE: We can not ship Delta 8 products to the following states: Alaska, Arizona, Arkansas, Colorado, Delaware`;
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "CherryPieces" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default CherryPiecesPage;
