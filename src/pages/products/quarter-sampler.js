...
import { ThcaQuarterSampler } from '../../components/products/quarter-sampler';
import { prices, formatSeoTitle, formatSeoDescription } from '/src/components/global';

const ThcaQuarterSamplerPage = ({
    pageContext: {
        breadcrumb: { crumbs }
    },
    location,
    ...
    return (
        <Layout location={location}>
            ...
            />
            <ThcaQuarterSampler productData={data} />
        </Layout>
    );
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "ThcaQuarterSampler" } }) {
            frontmatter {
                title
                crumbsPath
                crumbsLabel
...
export default ThcaQuarterSamplerPage;
