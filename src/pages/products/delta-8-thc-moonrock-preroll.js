...
import { THCMoonrockPreroll } from '../../components/products/thc-moonrock-preroll';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const THCMoonrockPrerollPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<THCMoonrockPreroll productData={data}/>
		</Layout>
	);
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "ThcMoonrockPreroll" } }) {
            frontmatter {
				title
				crumbsPath
				crumbsLabel
...
export default THCMoonrockPrerollPage;
