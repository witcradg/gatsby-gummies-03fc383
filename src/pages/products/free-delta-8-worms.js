...
import { FreeDelta8Worms } from '../../components/products/free-delta-8-worms';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const FreeDelta8WormsPage = ({ pageContext: { breadcrumb: { crumbs } }, location, data }) => {
	...
	return (
		<Layout location={location}>
			...
			<FreeDelta8Worms productData={data}/>
		</Layout>
	);
};
...
export const Head = ({location, data}) => {
	...
	// const description = `${pageTitle} 3 for the price of 2 delta 8 gummies sour worms 40mg per worm and 40 per 1000mg container. PLEASE NOTE: We can not ship Delta 8 products to the following states: Alaska, Arizona, Arkansas, Colorado, Delaware`;
...
export default FreeDelta8WormsPage;
