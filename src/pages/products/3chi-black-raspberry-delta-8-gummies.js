...
import { ChiBlackRaspberry } from '../../components/products/3chi-black-raspberry';
import { prices, formatSeoTitle, formatSeoDescription } from "/src/components/global"

const ChiBlackRaspberryPage = ({
    pageContext: {
        breadcrumb: { crumbs }
    },
    location,
    ...
    return (
        <Layout location={location}>
            ...
            />
            <ChiBlackRaspberry productData={data} />
        </Layout>
    );
};
...
export const query = graphql`
    query {
        markdownRemark(frontmatter: { cardName: { eq: "ChiBlackRaspberry" } }) {
            frontmatter {
                title
                crumbsPath
                crumbsLabel
...
export default ChiBlackRaspberryPage;
